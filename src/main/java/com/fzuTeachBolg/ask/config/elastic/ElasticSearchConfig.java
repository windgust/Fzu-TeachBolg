package com.fzuTeachBolg.ask.config.elastic;
...
@Component
@Configuration
@EnableElasticsearchRepositories(basePackages = "com.fzuTeachBolg.ask")
@ComponentScan(basePackages = {"com.fzuTeachBolg.ask"})
