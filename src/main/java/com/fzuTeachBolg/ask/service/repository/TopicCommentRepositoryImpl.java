...
import com.fzuTeachBolg.ask.util.query.UKAggResultExtractor;
import com.fzuTeachBolg.ask.util.query.UKAggTopResultExtractor;
import com.fzuTeachBolg.ask.util.query.UKResultMapper;
...
public class TopicCommentRepositoryImpl implements TopicCommentEsCommonRepository{
	...
	public Page<TopicComment> countByCon(
	    ...
	    if(elasticsearchTemplate.indexExists(Topic.class)){
	    	pages = elasticsearchTemplate.queryForPage(searchQuery, TopicComment.class  , new UKAggResultExtractor("creater") );
	    }
	    return pages ; 
	}
